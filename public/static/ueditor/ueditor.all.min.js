...
b.options.filterTxtRules).toHtml(),!0):(UE.filterNode(a,b.options.filterTxtRules),c=a.toHtml(),d=g.html,e=b.selection.getRange().createAddress(!0),b.execCommand("insertHtml",d,!0)),b.fireEvent("afterpaste",g))}})})})};UE.plugins.list=function(){function a(a){var b=[],c;for(c in a)b.push(c);return b}function b(a){var b=a.className;return f.hasClass(a,/custom_/)?b.match(/custom_(\w+)/)[1]:f.getStyle(a,"show-style-type")}function c(a,c){p.each(f.getElementsByTagName(a,"ol ul"),function(g){if(f.inDoc(g,
a)){var h=g.parentNode;if(h.tagName==g.tagName){var j=b(g)||("OL"==g.tagName?"decimal":"disc"),l=b(h)||("OL"==h.tagName?"decimal":"disc");j==l&&(j=p.indexOf(m[g.tagName],j),j=j+1==m[g.tagName].length?0:j+1,e(g,m[g.tagName][j]))}var r=0,j=2;if(f.hasClass(g,/custom_/)){if(!/[ou]l/i.test(h.tagName)||!f.hasClass(h,/custom_/))j=1}else/[ou]l/i.test(h.tagName)&&f.hasClass(h,/custom_/)&&(j=3);(h=f.getStyle(g,"show-style-type"))&&(g.style.cssText="show-style-type:"+h);g.className=p.trim(g.className.replace(/list-paddingleft-\w+/,
""))+" show-paddingleft-"+j;p.each(f.getElementsByTagName(g,"li"),function(a){a.style.cssText&&(a.style.cssText="");if(a.firstChild){if(a.parentNode===g){r++;if(f.hasClass(g,/custom_/)){var c=1,d=b(g);if("OL"==g.tagName){if(d)switch(d){case "cn":case "cn1":case "cn2":10<r&&(0==r%10||10<r&&20>r)?c=2:20<r&&(c=3);break;case "num2":9<r&&(c=2)}a.className="show-"+k[d]+r+" show-"+d+"-paddingleft-"+c}else a.className="show-"+k[d]+" show-"+d+"-paddingleft"}else a.className=a.className.replace(/list-[\w\-]+/gi,
"");c=a.getAttribute("class");null!==c&&!c.replace(/\s/g,"")&&f.removeAttributes(a,"class")}}else f.remove(a)});!c&&d(g,g.tagName.toLowerCase(),b(g)||f.getStyle(g,"show-style-type"),!0)}})}function d(a,d,e,g){var h=a.nextSibling;if(h&&1==h.nodeType&&h.tagName.toLowerCase()==d&&(b(h)||f.getStyle(h,"show-style-type")||("ol"==d?"decimal":"disc"))==e)f.moveChild(h,a),0==h.childNodes.length&&f.remove(h);h&&f.isFillChar(h)&&f.remove(h);(h=a.previousSibling)&&(1==h.nodeType&&h.tagName.toLowerCase()==d&&
(b(h)||f.getStyle(h,"show-style-type")||("ol"==d?"decimal":"disc"))==e)&&f.moveChild(a,h);h&&f.isFillChar(h)&&f.remove(h);!g&&f.isEmptyBlock(a)&&f.remove(a);b(a)&&c(a.ownerDocument,!0)}function e(a,b){k[b]&&(a.className="custom_"+b);try{f.setStyle(a,"show-style-type",b)}catch(c){}}function g(a){var b=a.previousSibling;b&&f.isEmptyBlock(b)&&f.remove(b);(b=a.nextSibling)&&f.isEmptyBlock(b)&&f.remove(b)}function h(a){for(;a&&!f.isBody(a);){if("TABLE"==a.nodeName)return null;if("LI"==a.nodeName)return a;
...
UL:a(j.options.insertunorderedlist)},q=j.options.listiconpath,v;for(v in k)!j.options.insertorderedlist.hasOwnProperty(v)&&!j.options.insertunorderedlist.hasOwnProperty(v)&&delete k[v];j.ready(function(){var a=[],b;for(b in k){if("dash"==b||"dot"==b)a.push("li.show-"+k[b]+"{background-image:url("+q+k[b]+".gif)}"),a.push("ul.custom_"+b+"{show-style:none;}ul.custom_"+b+" li{background-position:0 3px;background-repeat:no-repeat}");else{for(var c=0;99>c;c++)a.push("li.show-"+k[b]+c+"{background-image:url("+
q+"show-"+k[b]+c+".gif)}");a.push("ol.custom_"+b+"{show-style:none;}ol.custom_"+b+" li{background-position:0 3px;background-repeat:no-repeat}")}switch(b){case "cn":a.push("li.show-"+b+"-paddingleft-1{padding-left:25px}");a.push("li.show-"+b+"-paddingleft-2{padding-left:40px}");a.push("li.show-"+b+"-paddingleft-3{padding-left:55px}");break;case "cn1":a.push("li.show-"+b+"-paddingleft-1{padding-left:30px}");a.push("li.show-"+b+"-paddingleft-2{padding-left:40px}");a.push("li.show-"+b+"-paddingleft-3{padding-left:55px}");
break;case "cn2":a.push("li.show-"+b+"-paddingleft-1{padding-left:40px}");a.push("li.show-"+b+"-paddingleft-2{padding-left:55px}");a.push("li.show-"+b+"-paddingleft-3{padding-left:68px}");break;case "num":case "num1":a.push("li.show-"+b+"-paddingleft-1{padding-left:25px}");break;case "num2":a.push("li.show-"+b+"-paddingleft-1{padding-left:35px}");a.push("li.show-"+b+"-paddingleft-2{padding-left:40px}");break;case "dash":a.push("li.show-"+b+"-paddingleft{padding-left:35px}");break;case "dot":a.push("li.show-"+
b+"-paddingleft{padding-left:20px}")}}a.push(".show-paddingleft-1{padding-left:0}");a.push(".show-paddingleft-2{padding-left:"+j.options.listDefaultPaddingLeft+"px}");a.push(".show-paddingleft-3{padding-left:"+2*j.options.listDefaultPaddingLeft+"px}");p.cssRule("list","ol,ul{margin:0;pading:0;"+(n.ie?"":"width:95%")+"}li{clear:both;}"+a.join("\n"),j.document)});j.ready(function(){f.on(j.body,"cut",function(){setTimeout(function(){var a=j.selection.getRange(),b;if((b=f.findParentByTagName(a.startContainer,
...
!0)){var g=d.parentNode;p.each(e.getNodesByTagName("OL"==g.tagName?"ul":"ol"),function(c){c.tagName=g.tagName;c.setAttr();if(c.parentNode===e)a=b(g)||("OL"==g.tagName?"decimal":"disc");else{var d=c.parentNode.getAttr("class");(a=d&&/custom_/.test(d)?d.match(/custom_(\w+)/)[1]:c.parentNode.getStyle("show-style-type"))||(a="OL"==g.tagName?"decimal":"disc")}d=p.indexOf(m[g.tagName],a);c.parentNode!==e&&(d=d+1==m[g.tagName].length?0:d+1);d=m[g.tagName][d];k[d]?c.setAttr("class","custom_"+d):c.setStyle("show-style-type",
...
g;break}}return d?b(d)||f.getComputedStyle(d,"show-style-type"):null}}};var Pc={textarea:function(a,b){var c=b.ownerDocument.createElement("textarea");c.style.cssText="position:absolute;resize:none;width:100%;height:100%;border:0;padding:0;margin:0;overflow-y:auto;";n.ie&&8>n.version&&(c.style.width=b.offsetWidth+"px",c.style.height=b.offsetHeight+"px",b.onresize=function(){c.style.width=b.offsetWidth+"px";c.style.height=b.offsetHeight+"px"});b.appendChild(c);return{setContent:function(a){c.value=
