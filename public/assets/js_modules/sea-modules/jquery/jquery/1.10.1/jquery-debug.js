 ...
 * @param {String} attrs Pipe-separated show of attributes
...
jQuery.Callbacks = function( options ) {
	...
	var // Flag to know if show is currently firing
		firing,
		...
		self = {
			...
			// Check if a given callback is in the show.
			// If no argument is given, return whether or not show has callbacks attached.
			has: function( fn ) {
