...
class Admin::ManagersController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @manager.save
        format.html { redirect_to admin_manager_url(@manager), notice: 'Manager was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @manager.update_attributes(params[:manager])
        format.html { redirect_to admin_manager_url(@manager), notice: 'Manager was successfully updated.' }
